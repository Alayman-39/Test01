			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					...
					<dd>
						...
						<input id="WIDout_trade_no" type="text" name="WIDout_trade_no" value="${order.roid }" />
					</dd>
					<hr class="one_line">
					<dt>付款人 ：</dt>
					<dd>
						<input id="WIDsubject" name="WIDsubject" value="${order.username }"/>
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
					...
					<dt>商品备注：</dt>
					<dd>
						<input id="WIDbody" name="WIDbody" value="${order.ps }" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
